package com.peter_burbery.solve_advent_of_code_with_java_002.year_2015.day_022.part_001;
...
public class WizardSimulator {
	...
	static int simulate(Player player, Boss boss) {
	...
	public static void main(String[] args) {
		try {
			// Read input from the specified file path
			String input = Files.readString(
					Paths.get("Z:\\C\\advent-of-code-002\\jupyter-notebook-python\\2015\\2015_022\\input.txt"));
			...
			// Find the least mana spent
			int minManaSpent = simulate(player, boss);
			System.out.println("The least amount of mana spent to win is: " + minManaSpent);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
