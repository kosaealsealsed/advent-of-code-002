package com.peter_burbery.solve_advent_of_code_with_java_002.year_2016.day_011.part_002;
...
public class ElevatorPuzzle {
	...
	public static void main(String[] args) {
		try {
	        ...
	        // Manually add the new items to the parsed state
	        initialState.rtgFloors.put("elerium", 1);
	        initialState.rtgFloors.put("dilithium", 1);
	        initialState.chipFloors.put("elerium", 1);
	        initialState.chipFloors.put("dilithium", 1);
			// Start timing
...
/*
 * Iteration 12:
  Current BFS Depth: 12
  Queue Size: 179
  States Explored: 687
Iteration 24:
  Current BFS Depth: 24
  Queue Size: 472
  States Explored: 5447
Iteration 36:
  Current BFS Depth: 36
  Queue Size: 468
  States Explored: 11295
Iteration 48:
  Current BFS Depth: 48
  Queue Size: 135
  States Explored: 14716
Iteration 60:
  Current BFS Depth: 60
  Queue Size: 8
  States Explored: 15164
Solution found after 61 iterations and 61 steps!
Minimum steps: 61
Computation time: 820729300 nanoseconds
*/
