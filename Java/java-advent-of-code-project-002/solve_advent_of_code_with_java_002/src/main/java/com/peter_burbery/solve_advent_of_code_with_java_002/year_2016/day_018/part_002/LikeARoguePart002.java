package com.peter_burbery.solve_advent_of_code_with_java_002.year_2016.day_018.part_002;

import java.io.BufferedReader;
import java.io.FileReader;
import java.io.IOException;

public class LikeARoguePart002 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Calculate the number of safe tiles for 400,000 rows
            int rows = 400_000;
            long safeTileCount = countSafeTiles(initialRow, rows);

            // Timing end
            long endTime = System.nanoTime();
            double duration = (endTime - startTime) / 1_000_000_000.0;

            System.out.println("Number of safe tiles: " + safeTileCount);
