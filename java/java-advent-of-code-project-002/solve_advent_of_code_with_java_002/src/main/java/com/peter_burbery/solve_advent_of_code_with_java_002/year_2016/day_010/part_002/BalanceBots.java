package com.peter_burbery.solve_advent_of_code_with_java_002.year_2016.day_010.part_002;
...
public class BalanceBots {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Calculate the product of outputs 0, 1, and 2
        int product = outputs.getOrDefault(0, 1) * outputs.getOrDefault(1, 1) * outputs.getOrDefault(2, 1);
        System.out.println("Product of outputs 0, 1, and 2: " + product);
    }
