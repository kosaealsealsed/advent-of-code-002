 ...
 * @returns {string[]} - List of maze lines
 */
 ...
 * @param {string[]} mazeLines - List of maze lines
 * @returns {number} - The lowest possible score
 */
 ...
 * @param {string[]} mazeLines - List of maze lines
 * @returns {number} - Number of tiles on the best path
 */
